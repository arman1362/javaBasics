...
public class JavaCollections {
	...
	public static void main(String[] args) {
		...
		// in doubly Linked List nodes have the information about the next and previous
		// nodes
		...
		tempSet.add("jack");
		tempSet.add("david");
		System.out.println(tempSet.add("david")); // Hashset does not accept duplicate value
