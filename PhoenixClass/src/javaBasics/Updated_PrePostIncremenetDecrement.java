...
public class Updated_PrePostIncremenetDecrement {
	...
	public static void main(String[] args) {
		...
		System.out.println(++a + " " + b++); // the reason result is 15 for b because Java prints it first and then
												// increment it
		...
		// which becomes 6 and then num2 is not incrementing before printing and last
		// num1 takes the
		...
		int temp1 = 10;
		System.out.println(temp1 + 1);// number is added to temp1 just for printing. it is not actually added to
										// temp1.
        ...
        */
		...
		int num4 = 10;
		num4++;
		num4 = num4++ - --num4;// read from left to right num4++ = 11 because it is post increment and then
								// when
		// it reaches the second num4 it becomes 12 but first decrement by one since it
		// is pre-decrement therfore
		// 11 - 11 would be zero.
